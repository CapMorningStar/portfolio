...
> **Contact:** [kylwin@ucsd.edu](mailto:kylwin@ucsd.edu) · (+1) 650-609-8498 · [LinkedIn](https://linkedin.com/in/kyaw-soe-lwin-687643314) · [GitHub](https://github.com/CapMorningStar)

---

## ⚡ Architectural Highlights

- **Cosmic Genesis Singularity & Big Bang Intro:** 360° GPU particle physics simulation with smooth dissolve and equalized 3.6s identity pacing.
...
- **Animations:** Framer Motion + Canvas 2D / WebGL
- **Hosting & CI/CD:** [Vercel](https://vercel.com) (Global Edge Network)
...
```bash
# Clone repository
git clone https://github.com/CapMorningStar/portfolio.git
cd portfolio
...
MIT © [Kyaw Soe Lwin](https://kyawsoelwin.vercel.app)
