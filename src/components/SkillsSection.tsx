              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  {category.skills.map((skill) => (
                    <div
                      key={skill.name}
                      className="group flex flex-col items-center justify-center text-center p-4 rounded-2xl bg-[#181818]/80 border border-white/5 hover:border-cyan-500/40 hover:-translate-y-1 transition-all duration-200"
                    >
                      <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/5 border border-white/10 group-hover:border-cyan-500/50 mb-2.5 transition-colors">
